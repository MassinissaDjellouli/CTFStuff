...
## VPN traffic
- L2TP/IPsec:
  - L2TP creates a tunnel between the client and server, encapsulating the data packets. 
  - IPsec uses ESP (Encapsulating Security Payload) to encrypt the data within the tunnel, providing confidentiality and integrity.
    - IV is in the ESP header